...
# from yafti.screen.console import YaftiApplyChanges
from yafti.core.state import PackageScreenState

# this file is being deleted and being left for reference.
...
class PackageInstallScreen(YaftiScreen, Gtk.Box):
    ...
    async def on_activate(self):
        ...
        # self.console = YaftiApplyChanges()
